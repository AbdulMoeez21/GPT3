...
const GPT3 = () => {
  return (
    <div className="bg_blog p-10">
      <div className="upper flex md:flex-row flex-col">
        <span className="w-10 h-1 -mt-2  bg-gradient-to-r from-[#AE67FA]  via-[#F49867]  to-[#F49867]"></span>

        <h1 className="text-white font-semibold md:-ml-8 md:w-2/5 ">
          What is GPT-3?
        </h1>
      ...
      <div className="lower">
        <div className="flexx justify-between py-16 md:w-full w-96">
          <h1 className="text-transparent  bg-clip-text bg-gradient-to-r from-[#AE67FA]  via-[#F49867]  to-[#F49867] md:text-2xl text-lg md:w-96 w-64 font-semibold">
